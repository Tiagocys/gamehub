...
// .wrangler/tmp/pages-fV3ooQ/functionsWorker-0.16654764064018623.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var DEFAULT_META_PATH = "/img/meta.png";
...
__name2(stripTrailingSlash, "stripTrailingSlash");
...
__name(looksLikeBot, "looksLikeBot");
__name2(looksLikeBot, "looksLikeBot");
...
__name2(fetchListing, "fetchListing");
...
__name(fetchServerName, "fetchServerName");
__name2(fetchServerName, "fetchServerName");
...
__name(resolveListingImage, "resolveListingImage");
__name2(resolveListingImage, "resolveListingImage");
...
<body>
  <noscript>
    <p><a href="${escAppUrl}">Abrir an\xFAncio</a></p>
  </noscript>
</body>
</html>`;
}
__name(renderMetaPage, "renderMetaPage");
__name2(renderMetaPage, "renderMetaPage");
async function onRequestGet(context) {
  ...
  if (!supabaseUrl || !supabaseAnonKey) {
    return new Response("SUPABASE_URL/SUPABASE_ANON_KEY n\xE3o configuradas no Pages.", { status: 500 });
  }
  ...
  try {
    ...
    if (!listing) {
      const notFoundTitle = "An\xFAncio n\xE3o encontrado | Gimerr";
      const notFoundDescription = "Este an\xFAncio foi removido ou n\xE3o est\xE1 dispon\xEDvel.";
      const html2 = renderMetaPage({
        title: notFoundTitle,
    ...
    const listingTitle = truncateText(listing.title || "An\xFAncio no Gimerr", 110);
    const title = serverName ? `${listingTitle} \u2022 ${truncateText(serverName, 40)} | Gimerr` : `${listingTitle} | Gimerr`;
    const description = truncateText(
      listing.description || "Confira este an\xFAncio no marketplace da comunidade Gimerr.",
      200
    );
...
// node_modules/.deno/wrangler@4.64.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// node_modules/.deno/wrangler@4.64.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-CnNRfm/middleware-insertion-facade.js
...
// node_modules/.deno/wrangler@4.64.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-CnNRfm/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.16654764064018623.js.map
