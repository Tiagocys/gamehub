...
function getCopy(locale: string) {
  if (locale === "en") {
    return {
      ...
      approvedTitle: "Your game request was approved",
      rejectedTitle: "Your game request was not approved",
  ...
  return {
    ...
    approvedTitle: "Sua solicitação de game foi aprovada",
    rejectedTitle: "Sua solicitação de game não foi aprovada",
